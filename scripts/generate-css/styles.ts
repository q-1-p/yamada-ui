...
import type { AtRuleOptions, UIOptions } from "./ui-props"
import {
  isArray,
  isString,
  pseudoSelectors,
...
export const generateStyles = async (
  ...
  const addStyles = (
    ...
    ]: [string, AtRuleOptions | UIOptions],
    targetStyles: string[],
  ) => {
  ...
  Object.entries<AtRuleOptions>(atRuleProps).forEach((entry) =>
